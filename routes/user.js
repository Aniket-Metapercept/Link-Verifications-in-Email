...
const { getAllUser, createUser, getUserById, updateUserById, deleteUserById, login,sendUserEmail,optVerify,getUserByName,sendUserEmailLink,getUserByEmail } = require('../controller/user')
